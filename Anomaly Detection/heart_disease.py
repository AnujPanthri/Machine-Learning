...
# train_x,train_y,val_x,val_y,test_x,test_y=split_data_for_anomaly_detection(X,y,normal_split=(60,30,10),anomaly_split=(70,30))
...
show_confusion_matrix(confusion(test_y,y_pred,2),['0','1'])
